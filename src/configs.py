...
BIRD_SOUP_META_PATH_ALL = os.path.join(BIRD_SOUP_DIR, "metadata/bird_soup_uncased_v2.h5")   # 398K --> 440K

# BIRD_SOUP_META_PATH_TEST  = f"{BIRD_SOUP_DIR}/metadata/v2/pretrain_exclude_cub/cub_classes_all.h5"
...
BIRD_SOUP_META_PATH_VAL   = f"{BIRD_SOUP_DIR}/metadata/level_1_exclude_cub_nabirds_inat/val_keep_child_a100_reindexed.h5"
BIRD_SOUP_META_PATH_TEST  = f"{BIRD_SOUP_DIR}/metadata/level_1_exclude_cub_nabirds_inat/test_cub_reindexed.h5"

# For BirdSoup-v2.1 (Level 3)
# CUB
# BIRD_SOUP_META_PATH_TRAIN = f"{BIRD_SOUP_DIR}/metadata/level_3_exclude_cub/train_keep_child_a100_reindexed.h5"
# BIRD_SOUP_META_PATH_VAL   = f"{BIRD_SOUP_DIR}/metadata/level_3_exclude_cub/val_keep_child_a100_reindexed.h5"
# BIRD_SOUP_META_PATH_TEST  = f"{BIRD_SOUP_DIR}/metadata/level_3_exclude_cub/clore_split/test_unseen_reindexed.h5"

# NABIRDS
# BIRD_SOUP_META_PATH_TRAIN = f"{BIRD_SOUP_DIR}/metadata/level_3_exclude_nabirds/train_keep_child_a100_reindexed.h5"
# BIRD_SOUP_META_PATH_VAL   = f"{BIRD_SOUP_DIR}/metadata/level_3_exclude_nabirds/val_keep_child_a100_reindexed.h5"
# BIRD_SOUP_META_PATH_TEST  = f"{BIRD_SOUP_DIR}/metadata/level_1_exclude_cub_nabirds_inat/test_nabirds_reindexed.h5"
